...
<main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="tile">
          <form action="<?php if(Auth::user()->is_admin==1): ?><?php echo e(route('admin.village_add')); ?> <?php elseif(Auth::user()->is_admin==2): ?> <?php echo e(route('village_add')); ?> <?php endif; ?>" method="post">
            <?php echo csrf_field(); ?>
          <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hasilcop/pgdit.hasibuzzaman.com/resources/views/common/add_village.blade.php ENDPATH**/ ?>