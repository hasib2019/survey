    ...
    <div class="col-md-12">
      <div class="tile">
        <div class="tile-body">
            ...
            <form class="form-inline" action="<?php if(Auth::user()->is_admin==1): ?><?php echo e(route('admin.union.serch')); ?> <?php elseif(Auth::user()->is_admin==2): ?> <?php echo e(route('union.serch')); ?> <?php endif; ?>" method="get">
              <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hasilcop/pgdit.hasibuzzaman.com/resources/views/common/union_serch.blade.php ENDPATH**/ ?>