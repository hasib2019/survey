        ...
        <div class="col-lg-12 border">
          <div class="form-row">
            ...
            <div class="form-group col-md-6">
              ...
              <select name="district" id="demoSelect" class="form-control" required>
                ...
                <option value="{{$districts->id}}" @if($districts->id==$allSurveyData->district) selected @endif>{{$districts->district_name_bangla}}
		</option>
                @endforeach
              </select>
            </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="text" name="informer_name" id="" value="{{$allSurveyData->informer_name}}" class="form-control" required placeholder="তথ্য সংগ্রহকারীর নাম" value="{{$allSurveyData->informer_name}}">
            </div>
            <div class="form-group col-md-6">
              <label>তথ্য সংগ্রহকারীর পদবি:</label>
              <input type="text" name="informer_designation" value="{{$allSurveyData->informer_designation}}" id="" class="form-control" required placeholder="তথ্য সংগ্রহকারীর পদবি" value="{{$allSurveyData->informer_designation}}">
            </div>
          </div>
        </div>
        {{-- district section --}}
