    ...
    datasets: [
      {
        ...
        data: [@php echo App\Models\ElectionSurvey::where('gender', 'm')->where('district',20)->count(); @endphp, 59, 80, 81, 56]
      },
      {
        ...
        data: [@php echo App\Models\ElectionSurvey::where('gender', 'm')->where('district',22)->count(); @endphp, 48, 40, 19, 86]
      }
    ]
  };
  var pdata = [
